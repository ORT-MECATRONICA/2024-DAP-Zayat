...
List usuarios = [
  User(email: "LucasZ", password: "Comunicaciones"),
  User(email: "RamiroL", password: "Ferro"),
  User(email: "FelianoM", password: "Skate"),
  User(email: "LeandroA", password: "Gimnasio"),
  User(email: "UlisesB", password: "PlayStation4")
];
var logged = false;
